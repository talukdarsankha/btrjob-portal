...
if (isset($_SESSION['user-email']) && isset($_SESSION['user-password'])) {
	...
	{
		$_SESSION['errLogin'] = "Username or Password is incorrect. <br>Please try again.";
...
?>
                   ...
                   <?php
               if (isset($_SESSION['userType']) && $_SESSION['userType']=="COUNSELLOR") {
                   echo  $_SESSION['userType'];
                }else if($_SESSION['userType']=="ADMIN"){
                    echo  $_SESSION['userType'];
                }else if($_SESSION['userType']=="APPLICANT"){
                    echo  $_SESSION['userType'];
                }else{
                    echo  $_SESSION['userType'];
                }
