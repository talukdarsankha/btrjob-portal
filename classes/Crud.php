<?php
  ...
  class Crud extends DbConfig {
    ...
    // total sum
    public function Sum($ColumnName, $Variable,$TableName,$Condition) {
 ...
 // SELECT SUM(Quantity) AS TotalItemsOrdered FROM OrderDetails; 
      $sql = "SELECT SUM(".$ColumnName.") AS ".$Variable." FROM ".$TableName." WHERE ".$Condition;
    ...
    public function retrieveID($data, $table) {
        // ... Your existing code for inserting data ...

        // After the INSERT operation, get the last inserted ID
