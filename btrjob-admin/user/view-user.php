...
<body class="bg-light">
  ...
  <!-- Edit Modal start -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    ...
                    <input type="button" id="delete-counsellor"  class="btn btn-danger waves-effect" value="Delete " >
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table id="table-2" class="display text-center">
                                    ...
                                    <tbody>
                                    <?php
                                        $readcounsellor=$crud->Read("users","`user_type`='COUNSELLOR' ORDER BY `id` desc"); 
                                        if($readcounsellor){ 
                                            foreach($readcounsellor as $counsellor){
                                    ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="form-check-input" name="checkbox1"
                                            ...
                                            <td>
                                                <div class="employee d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="<?php echo $counsellor["user_image"] ; ?>" alt="img" width="100px" height="80px">
                                                    </div>
                                                    <div class="description">
                                                        <h6 class="mb-0"><?php echo $counsellor["name"]." ".$counsellor["surname"]; ?></h6>
                                                        <small><?php echo $counsellor["email"]; ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?php echo $counsellor["email"]; ?></td>
                                            <td><?php echo $counsellor["phone"]; ?></td>
                                            <td>
                                                
                                            <?php 
                                                  if($counsellor["status"]==0){
                                            ...
                                            <td><?php echo $counsellor["added_date"]; ?></td>
                                            <td>
                                                <div class="dropdown">
                                                    <a href="#" data-bs-toggle="dropdown" class="fs-24 text-gray">
                                                        <i class="bi bi-three-dots-vertical"></i>
                                                    ...
                                                    <div class="dropdown-menu p-0">
                                                        <p class="dropdown-item edit-counsellor" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?php echo $counsellor["id"]; ?>">Edit</p>
                                                        
                                                        <!-- <p class="dropdown-item text-danger" id="delete-counsellor2" >Delete</p> -->
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <?php include("include/footer.php") ?>
     ...
     <script>
        $(function () {
        $('.edit-counsellor').on('click', function () {
       ...
       $(function () {
        $('#update-user').on('click', function () {
            ...
            var counsellorId = $("#edit_user_id").val();
    ...
    $(function () {
        $('#delete-counsellor').on('click', function () {
    ...
    // $(function () {
    //     $('#delete-counsellor2').on('click', function () {
    ...
    //             });
    //         } else {
    //             alert('Counsellor deletion aborted.');
    //         }
