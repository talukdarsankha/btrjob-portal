                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            ...
                                            <div class="avatar-content">
                                                <h6 class="fw-semibold" style="margin-top: 30px;color: rgb(54, 137, 225);margin-bottom: 0px;">Total Selection <i class="fa-solid fa-users pr-2" style="font-size: x-large;"></i> 
                                                </h6>
                                                        <?php
