                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-3">
                                                <div class="card-content" style="height: 90px;">
                                                    <h6 style="color: rgb(177, 78, 165);">Company / Business Name :</h6>
                                            ...
                                            <div class="avatar-content">
                                                <h6 class="fw-semibold" style="margin-top: 30px;color: rgb(63, 145, 97);margin-bottom: 0px;">Total Rejection <i class="fa-solid fa-users pr-2" style="font-size: x-large;"></i> 
                                                </h6>
                                                        <?php
