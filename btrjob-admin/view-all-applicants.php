                        ...
                        <div
                            class="card-header pb-5 bg-transparent border-0 d-flex align-items-center justify-content-between gap-3">
                                ...
                                <div class="row fill-width">
                                   ...
                                   <?php 
                                   if($readjob && isset($readjob[0]['applicant_id'])) {
                                    $companyid = $readjob[0]['job_id'];
                                    $applicant_id = $readjob[0]['applicant_id'];
                                    ?>
                                    ...
                                    <?php 
                                            ...
                                            echo '<p>No applicants have applied for this job.</p>';
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($status == 3) {
                                                                         ...
                                                                         echo '<span class="custom-badge-hire">Hired</span>';
                                                                    } elseif($status == 4) {
                                                                        echo '<span class="custom-badge-interview">called for interview</span>';
                                                                    }elseif($status ==1){
                                                                ...
                                                                <td><a href="applicant-info?applicant_id=<?php echo $applicant_id;?>&job_id=<?php echo $job_id ; ?>"><button class="apply">Details</button></a></td>
