                                ...
                                <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php 
                                          ...
                                          $rejects=$crud->Read("job_applied","`company_id`=$company_id and `status`=3 order by `id` desc");
                                          if($rejects){
                                            $num=0;
                                            foreach($rejects as $rejected){
                                        ...
                                        <?php
                                            ...
                                            echo  '<h3 class="text-warning text-center">No Details Found</h3>';
                                          }
                                        ?>
