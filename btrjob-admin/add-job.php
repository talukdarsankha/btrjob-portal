                    ...
                    <div class="card-body p-0 pt-4">
                        ...
                        <form  method="post"  enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">Company Advertisement(if any)</label>
                                    <input type="file" class="form-control" name="advertisementPdf" id="advertisementPdf" accept=".pdf" value="">
                                </div>
...
<script type="text/javascript">
    ...
    $('#add-job').on('click', function () {
        ...
        var experience = $("#experience").val();
        var end_date = $("#end_date").val();
        var advertisementPdf = $("#advertisementPdf")[0].files[0];
        // var advertisementPdf = $("#advertisementPdf").val();        
        ...
        if (job_title === "" || job_location === "" || state === "" || Jobdescription === "" || district === "" || salary === "" || category === "" || jobtype === "" || qualification === "" || experience === "" || end_date === "" ) {
            ...
            formData.append('advertisementPdf', advertisementPdf);
