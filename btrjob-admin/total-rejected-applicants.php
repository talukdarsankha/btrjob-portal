            ...
            <div class="inner-contents">
                <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                    <div class="left-part">
                        ...
                        <p class="text-gray mb-0"> all applicants, who are rejected by any job in this portal .</p>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                ...
                                <table id="example" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                            $readJob = $crud->Read("job_applied", "`status`=3 order by `id` desc");
                                            if ($readJob) {
                                            $n = 0; 
                                            foreach ($readJob as $job) {
                                                ...
                                                <tr>
                                                    <td><?php echo ++$n; ?></td>
                                                    <td><span class="badge badge-pill badge-danger">KYC rejected</span>
                                                    </td>
