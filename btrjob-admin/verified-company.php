        ...
        <div class="container-fluid">
            <div class="inner-contents">
                <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                    <div class="left-part">
                        <h2 class="text-dark">Verified Companies</h2>
                ...
                <div class="row">
                    <?php
                          $ReadCompany=$crud->Read("company","status='2' order by id desc");
                          if($ReadCompany){
                            ...
                            <div class="card-body">
                                <div class="align-items-center gap-4" >
                                   <div class="avatar-img avatar-xl rounded-2 overflow-hidden flex-shrink-0">
                                        ...
                                        ?>
                                                <img src="assets/img/icons/office.gif" alt="Default logo" class="w-100" />
                                        <?php 
                                            }
                                        ?>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between gap-3 flex-wrap">
                                    <a href="uploads/<?php echo $company["trade_license"]; ?>" target="_blank">
                                    <div
                    ...
                    <?php        
                     ...
                     ?>
                    <div class="">
                        <h2 class="text-center">No Verified Companies</h2>
                    </div>
                    <?php       
                          }
                    ?>
