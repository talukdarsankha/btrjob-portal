                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2 gap-sm-4 mb-5 flex-wrap"> 
                                ...
                                <?php
                                  ...
                                  if($btn){
                                    ...
                                    ?>
                                        <div class="d-flex justify-content-between justify-content-lg-start">
                                        <button class="interview me-lg-2 mb-2 mb-lg-0" id="interview" data-bs-toggle="modal" data-bs-target="#add-event">Interview</button>
                                    ...
                                    <?php
                                        ...
                                        '
                                        <div class="d-flex justify-content-between justify-content-lg-start">
                                        <button class="interview" style="width: 150px; color: rgb(253, 251, 251);">Invitation</button>                             
                                        </div>
                                        '; 
                                    }
