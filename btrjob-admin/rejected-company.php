...
<body class="bg-light">
    ...
    <main class="main-wrapper">
        <div class="container-fluid">
            <div class="inner-contents">
                ...
                <div class="row">
                    <?php
                          $ReadCompany=$crud->Read("company","status='3' order by `id` desc");
                          if($ReadCompany){
                    ...
                    <?php        
                     ...
                     ?>
                    <div class="">
                        <h2 class="text-center" style="color: #009fff;">No Rejected Companies</h2>
                    </div>
                    <?php       
                          }
                    ?>
    ...
    <script>
       $(function () {
        ...
        if (confirm('do you want to verify this company?')) {
            $.ajax({
            type: "POST", 
            dataType: "json",
