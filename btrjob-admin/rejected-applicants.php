            ...
            <div class="inner-contents">
                <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                    <div class="left-part">
                        ...
                        <p class="text-gray mb-0"> all applicants, who are rejected .</p>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card border-0 p-5">
                        ...
                        <div class="card-body p-0">
                            <?php
                            $readApplicant = $crud->Read("applicant", "`status`='3' order by `id` desc");
                            ...
                            <div class="table-responsive">
                                ...
                                <!-- datatable -->
                                <table id="example" class="display nowrap table-info" style="width:100%">
                                    <thead>
                                        <tr>
                                           <th>Sl no.</th>
                             ...
                             <?php
                                ...
                                ?>
                                <h2 class="text-center" style="color: #009fff;">No Rejected Applicants</h2>
                            <?php
                            }
                            ?>
                        </div>
