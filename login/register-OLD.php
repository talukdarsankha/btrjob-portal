...
$(document).ready(function(){
    ...
    //             if (response === 'invalid'){
    //                 $('#email-error').text('Invalid Email address').css('color', 'red');
    //                 $('#email-btn').hide(); // Hide the email button if email is invalid or exists
    //             } else if(response === 'exists') { 
    //                 $('#email-error').text('Email already exists').css('color', '');
    //                 $('#email-btn').hide(); 
    //             }else { 
    //                 $('#email-error').text('').css('color', '');
    //                 $('#email-btn').show(); 
...
<script>
        $(function () {
            $('#register').on('click', function () {
                ...
                if (email === "" || email === null || phone === "" || phone === null ||  userType === "" || userType === null) {
                    Swal.fire({
                        icon: 'error',
