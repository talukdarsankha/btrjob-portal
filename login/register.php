			...
			<div class="row">
				...
				<div class=" col-sm-5 col-md-3 col-lg-3 col-xl-3 col-12 order-md-1 fxt-bg-color">
					<div class="fxt-content">
						...
						<div class="fxt-form">
							<h2>Register</h2>
							<p style="color: #00abff;">( Registration form )</p>
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-5">
										<div class="text-center">
											<button type="" id="register" class="fxt-btn-fill">Register </button>
											<button type="" id="register2" class="fxt-btn-fill">Register </button>
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response === 'invalid') {
                    ...
                    $('#phone-error').text('Select a valid role').css('color', 'red');
                    $("#register").prop("disabled", true);
                }  
                else {
                    $('#phone-error').text('').css('color', ''); 
...
<script>
                    ...
                    success: function (response) {
                        ...
                        if (response.status === 'success') {
                            Swal.fire({
                                ...
                                window.location.href = '../btrjob-admin/index';
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
    ...
    <script>
      $('#register2').on('click', function (){
        var email = $("#email").val();
        if(email=="" || email==null){
            $('#email-error').text('Enter Your Email Account.').css('color', 'red');
        }else{
            $('#email-error').text('Verify Your Email Account.').css('color', 'red');
        }
