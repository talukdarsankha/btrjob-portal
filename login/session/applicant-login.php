...
date_default_timezone_set('Asia/Kolkata');
	...
	$stmt=$con->prepare("SELECT * FROM `applicant` WHERE (`email`='$email') AND `password`='$hash'");
	$stmt->execute();
	// var_dump($stmt);
	...
	{	
			...
			$sql2 = $con -> prepare("INSERT INTO `applicant_login_details` (`user_id`, `os`, `browser`, `ip`, `login_date`, `login_time`) VALUES ('$user_id', '$os', '$browser', '$ip', '$login_date', '$login_time')");
