                            ...
                            <div class="jp_register_section_main_wrapper">
                                <div class="jp_regis_left_side_box_wrapper">
                                    <div class="jp_regis_left_side_box">
                                        ...
                                        <ul>
                                            <li><a href="login/register"><i class="fa fa-plus-circle"></i> &nbsp;REGISTER </a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <?php
                    if ($joblist) {
                        ...
                        foreach ($joblist as $jobKey) {
                            ...
                            $lastDate = $jobKey['last_date']; 
                            $currentDate = date('Y-m-d'); 
                    
                            // Check if the last date has not passed
                                    ...
                                    <div class="jp_popu_cate_box_main_wrapper jp_popu_cate_box_main_wrapper_second">
                                        <div class="jp_top_jobs_category_wrapper">
                                            <div class="jp_top_jobs_category">
                                                ...
                                                <h3><a href="job-details?jobid=<?php echo $jobID; ?>"><?php echo $jobtitle; ?></a></h3>
                                                <h4><img src="images/icon/office.gif" style="max-width: 32px"><a
                                                        href="#"><?php echo $jobKey['state']; ?></a></h4>
                                                ...
                                                <a href="job-details?jobid=<?php echo $jobID; ?>"><button type="button" class="btn-outline-success apply">Apply</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="jp_recent_resume_view_btn_wrapper">
                        <div class="jp_recent_resume_view_btn">
                            <ul>
                                <li><a href="job-listings"><i class="fa fa-plus-circle"></i> &nbsp;VIEW ALL</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
